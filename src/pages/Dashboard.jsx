    ...
    <div className="p-6 bg-gradient-to-br from-rose-50 to-pink-100 min-h-screen">
      ...
      <div className="bg-white p-4 rounded-lg shadow mb-6">
        ...
        <div className="flex gap-2">
          ...
          />
          <button onClick={handleSend} className="bg-rose-500 text-white px-4 rounded hover:bg-rose-600">Send</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          ...
          />
          <button onClick={handleDiarySave} className="w-full bg-rose-400 text-white py-2 rounded hover:bg-rose-500">Save Diary</button>
        </div>
      </div>
